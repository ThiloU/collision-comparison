...
subdirectory_name = "../data/complex_env_dual_arm_collision_max256verts"
...
while i <= datasets:
    ...
    if len(cases) > 0:
        print(i)
        write_test_file(cases, subdirectory_name, f"complex_env_dual_arm_collision_max256verts_{i}.json", hull_max_vertices=256)
        i += 1
